...
import com.example.practicaexamenii.databinding.ActivityInicioSesionBinding
...
class InicioSesion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.txtViewRegistrarUsuario.setOnClickListener {
            val intentRegistro = Intent(this, Registrar::class.java)
            startActivity(intentRegistro)
        }

        binding.txtViewBackPassword.setOnClickListener {
            val intentRecoveryPassword = Intent(this, RecuperarPass::class.java)
    ...
    private fun infoUser() {
        val infoUserIntent = Intent(this, InfoUsuario::class.java)
